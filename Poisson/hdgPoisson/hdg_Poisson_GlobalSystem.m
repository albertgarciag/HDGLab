...
function [uhat, local] = hdg_Poisson_GlobalSystem(mesh,refElem,refFace,hdg,ctt,problemParams)
...
for iElem = 1:mesh.nOfElements
    ...
    [Zqle,Zule,zqfe,zufe,Ke,fe] = hdg_Poisson_ElementalMatrices(refElem,refFace,Xe,pElem,matElem,hdg.tau,faceInfo,ctt,problemParams);
